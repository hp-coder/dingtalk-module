...
public class DingWorkNotifyMsg implements IDingWorkNotifyMsg {
    ...
    public static void main(String[] args) {
        final DingWorkNotifyMsg dingWorkNotifyMsg = new DingWorkNotifyMsg(new OapiMessageCorpconversationAsyncsendV2Request.Voice());
        System.out.println(dingWorkNotifyMsg.getMsg());
    }
